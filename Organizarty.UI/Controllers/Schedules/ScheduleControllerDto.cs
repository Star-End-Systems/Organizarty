...
public record OrderResponse(string id, string Name, DateTime Date, String Type, String Note, int Quantity, string Status)
{
...
public record ScheduleResponse(string id, string Name, DateTime Date, string Type, decimal price, List<OrderResponse> orders)
{
